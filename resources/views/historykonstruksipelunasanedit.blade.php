...
<div class="mt-3">
    <div class="section-title">
        <span>Submit Transaksi Pelunansan</span>
        <h2>ubmit Transaksi Pelunansan</h2>
    </div>
<form method="post" action="/historyKonstruksiPelunasan/{{$pemesananjasa->id}}" class="mb-5" enctype="multipart/form-data">
    @method('put')
    @csrf

    <div class="mb-3">
        <label for="total_bayar" class="form-label">Total Yang Harus Dibayar Lagi</label>
    ...
    <div class="alert alert-danger col-5" role="alert">
        ...
        Wajib Melakukan Pelunasan <br>
        Rekening : 1080077177377 PT Rovina Jaya Sentosa Bank Mandiri. Terima Kasih
    </div>

    <div class="mb-3">
        <label for="bukti_transaksi_pelunasan" class="form-label @error('bukti_transaksi_pelunasan') is-invalid @enderror">Bukti Transaksi Pelunasan</label>
