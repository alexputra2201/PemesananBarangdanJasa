...
<form action="/product" method="post" class="mb-5" enctype="multipart/form-data">
    ...
    <div class="design" id="design">
        ...
        <div class="mb-3">
            ...
            <a href="" class="bi bi-exclamation-circle" data-bs-toggle="modal" data-bs-target="#sketsa"></a>

            <div class="modal fade" id="sketsa" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                <div class="modal-dialog modal-dialog-centered">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title" id="exampleModalLabel">Deskripsi Sketsa</h5>
                            <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                        </div>
                        <div class="modal-body">
                            Sketsa ini merupakan gambaran kasar dari customer untuk membuat suatu desain yang ingin
                            dipesan ke developer PT Rovina Jaya Sentosa
                        </div>
            ...
            <div class="modal fade" id="deskripsi" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                <div class="modal-dialog modal-dialog-centered">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                           Deskripsi ini memaparkan atau menguraikan pesanan dari jasa desain customer ke developer PT Rovina Jaya Sentosa
                        </div>
                        <div class="modal-footer">
                            <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
                        </div>
        ...
        <div class="mb-3">
            <label for="bukti_transaksi" class="form-label @error('bukti_transaksi') is-invalid @enderror">Bukti
                Transaksi</label>
            <img class="img-preview2 img-fluid mb-3 col-sm-5">
            <input class="form-control" type="file" id="bukti_transaksi" name="bukti_transaksi"
