...
<section id="portfolio" class="portfolio">
    <div class="container">
        <div class="section-title">
            <span>Perumahan Rovina Residence</span>
...
<a href="/pemesananbarang2/create" class="btn btn-primary mb-3">Pesan Perumahan</a>
        ...
        <div class="row portfolio-container">
            ...
            <div class="col-lg-4 col-md-6 portfolio-item">
                <img src="{{ asset('Rumah/1.jpg') }}" class="img-fluid" alt="">
            ...
            <div class="col-lg-4 col-md-6 portfolio-item">
                <img src="{{ asset('Rumah/18.jpg') }}" class="img-fluid" alt="">
                {{-- <img src="{{ asset('storage/' . $product->image) }}" class="img-fluid" alt=""> --}}
                <div class="portfolio-info">
                    <h4>Ruang Tamu</h4>
                    {{-- <a href="{{ asset('storage/' . $product->image) }}" data-gallery="portfolioGallery"
            ...
            <div class="col-lg-4 col-md-6 portfolio-item">
                <img src="{{ asset('Rumah/24.jpg') }}" class="img-fluid" alt="">
                {{-- <img src="{{ asset('storage/' . $product->image) }}" class="img-fluid" alt=""> --}}
                <div class="portfolio-info">
                    <h4>Kamar Tidur</h4>
                    {{-- <a href="{{ asset('storage/' . $product->image) }}" data-gallery="portfolioGallery"
            ...
            <div class="col-lg-4 col-md-6 portfolio-item">
                <img src="{{ asset('Rumah/10.jpg') }}" class="img-fluid" alt="">
                {{-- <img src="{{ asset('storage/' . $product->image) }}" class="img-fluid" alt=""> --}}
                <div class="portfolio-info">
                    <h4>Taman</h4>
                    {{-- <a href="{{ asset('storage/' . $product->image) }}" data-gallery="portfolioGallery"
            ...
            <div class="col-lg-4 col-md-6 portfolio-item">
                <img src="{{ asset('Rumah/9.jpg') }}" class="img-fluid" alt="">
                {{-- <img src="{{ asset('storage/' . $product->image) }}" class="img-fluid" alt=""> --}}
                <div class="portfolio-info">
                    <h4>Toilet</h4>
                    {{-- <a href="{{ asset('storage/' . $product->image) }}" data-gallery="portfolioGallery"
            ...
            <div class="col-lg-4 col-md-6 portfolio-item">
                <img src="{{ asset('Rumah/15.jpg') }}" class="img-fluid" alt="">
                {{-- <img src="{{ asset('storage/' . $product->image) }}" class="img-fluid" alt=""> --}}
                <div class="portfolio-info">
                    <h4>Dapur</h4>
                    {{-- <a href="{{ asset('storage/' . $product->image) }}" data-gallery="portfolioGallery"
